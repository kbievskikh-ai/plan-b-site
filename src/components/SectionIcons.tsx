...
// Map section key to icon component
export const SECTION_ICONS: Record<string, React.FC<{ className?: string }>> = {
  'market-reports': MarketReportsIcon,
  'city-reports': CityReportsIcon,
  'district-guides': DistrictGuidesIcon,
  'developer-reviews': DeveloperReviewsIcon,
  'guides': GuidesResourcesIcon,
  'all': AllReportsIcon,
};
