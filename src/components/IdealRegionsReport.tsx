    ...
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="bg-gradient-to-r from-[#009739] via-[#1B2951] to-[#D4AF37] text-white py-3 text-center">
        ...
        <div className="flex gap-1 justify-center mt-1.5">
          ...
          <a href={waUrl(lang)} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex items-center px-1.5 py-0.5 rounded bg-[#25D366]/90 text-white">
      ...
      <div className="max-w-2xl mx-auto px-3 py-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-3">
          ...
          <a href={waUrl(lang)} target="_blank" rel="noopener noreferrer" className="block text-center bg-[#1B2951] text-[#E8C84A] border border-[#D4AF37]/20 py-2.5 rounded-lg text-[11px] font-semibold hover:opacity-90 transition-opacity">
            {L.premBtn}
          </a>
        </div>
