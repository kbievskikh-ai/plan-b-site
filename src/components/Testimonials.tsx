...
const testimonials = [
  {
    ...
    quote: "Plan B made our first international property investment seamless. Their team guided us through every step, from property selection to legal documentation. Our Balneário Camboriú apartment has exceeded ROI expectations.",
  ...
  },
  {
    ...
    quote: "We dreamed of a vacation home in Brazil for years. The Plan B team understood our vision and found us the perfect villa in Florianópolis. The process was transparent and their ongoing property management service is excellent.",
    image: null,
  },
  {
    id: 3,
    ...
    quote: "As a portfolio investor, I needed a partner who understood both the Brazilian market and international tax implications. Plan B delivered comprehensive analysis and helped me build a diversified Brazilian property portfolio.",
    image: null,
  },
  {
    id: 4,
    ...
    quote: "Moving to Brazil was a big decision. Plan B not only found us the ideal home in Itapema but also connected us with relocation services, banking, and local community. True end-to-end support.",
    image: null,
  },
];
