...
const visaPrograms = [
  {
    ...
    nameKey: 'programs.investment_name', nameKeyRu: 'programs.investment_nameRu',
    descKey: 'programs.investment_desc', descKeyRu: 'programs.investment_descRu',
    bestForKey: 'programs.investment_bestFor', bestForKeyRu: 'programs.investment_bestForRu',
  ...
  },
  {
    ...
    nameKey: 'programs.business_name', nameKeyRu: 'programs.business_nameRu',
    descKey: 'programs.business_desc', descKeyRu: 'programs.business_descRu',
    bestForKey: 'programs.business_bestFor', bestForKeyRu: 'programs.business_bestForRu',
  ...
  },
  {
    ...
    nameKey: 'programs.retirement_name', nameKeyRu: 'programs.retirement_nameRu',
    descKey: 'programs.retirement_desc', descKeyRu: 'programs.retirement_descRu',
    bestForKey: 'programs.retirement_bestFor', bestForKeyRu: 'programs.retirement_bestForRu',
  ...
  },
  {
    ...
    nameKey: 'programs.nomad_name', nameKeyRu: 'programs.nomad_nameRu',
    descKey: 'programs.nomad_desc', descKeyRu: 'programs.nomad_descRu',
    bestForKey: 'programs.nomad_bestFor', bestForKeyRu: 'programs.nomad_bestForRu',
  ...
  },
  {
    ...
    nameKey: 'programs.family_name', nameKeyRu: 'programs.family_nameRu',
    descKey: 'programs.family_desc', descKeyRu: 'programs.family_descRu',
    bestForKey: 'programs.family_bestFor', bestForKeyRu: 'programs.family_bestForRu',
    processingTime: '1–3 months', processingTimeRu: '1–3 мес',
    visaType: 'Temporary → Permanent', visaTypeRu: 'Временная → ПМЖ',
    citizenshipEligible: true, citizenshipYears: 4,
  ...
  },
  {
    ...
    nameKey: 'programs.marriage_name', nameKeyRu: 'programs.marriage_nameRu',
    descKey: 'programs.marriage_desc', descKeyRu: 'programs.marriage_descRu',
    bestForKey: 'programs.marriage_bestFor', bestForKeyRu: 'programs.marriage_bestForRu',
    processingTime: '1–3 months', processingTimeRu: '1–3 мес',
    visaType: 'Permanent (PR)', visaTypeRu: 'ПМЖ',
